...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Токен аутентификации вошедшего в систему пользователя
}
...
type IsAdminRequest struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // ID пользователя, который мы хотим проверить
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x15, 0x6b, 0x6f, 0x76, 0x61, 0x6c, 0x79, 0x6f, 0x76, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76,
